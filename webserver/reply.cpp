...
namespace status_strings {
	...
	constexpr const char *switching_protocols = "HTTP/1.1 101 Switching Protocols\r\n";
	constexpr const char *download_file = "HTTP/1.1 102 Download File\r\n";
	constexpr const char *ok = "HTTP/1.1 200 OK\r\n";
	constexpr const char *created = "HTTP/1.1 201 Created\r\n";
	constexpr const char *accepted = "HTTP/1.1 202 Accepted\r\n";
	constexpr const char *no_content = "HTTP/1.1 204 No Content\r\n";
	constexpr const char *multiple_choices = "HTTP/1.1 300 Multiple Choices\r\n";
	constexpr const char *moved_permanently = "HTTP/1.1 301 Moved Permanently\r\n";
	constexpr const char *moved_temporarily = "HTTP/1.1 302 Moved Temporarily\r\n";
	constexpr const char *not_modified = "HTTP/1.1 304 Not Modified\r\n";
	constexpr const char *bad_request = "HTTP/1.1 400 Bad Request\r\n";
	constexpr const char *unauthorized = "HTTP/1.1 401 Unauthorized\r\n";
	constexpr const char *forbidden = "HTTP/1.1 403 Forbidden\r\n";
	constexpr const char *not_found = "HTTP/1.1 404 Not Found\r\n";
	constexpr const char *internal_server_error = "HTTP/1.1 500 Internal Server Error\r\n";
	constexpr const char *not_implemented = "HTTP/1.1 501 Not Implemented\r\n";
	constexpr const char *bad_gateway = "HTTP/1.1 502 Bad Gateway\r\n";
	constexpr const char *service_unavailable = "HTTP/1.1 503 Service Unavailable\r\n";
...
namespace stock_replies {
	...
	constexpr char switching_protocols[] = "";
	constexpr char download_file[] = "";
	constexpr char ok[] = "";
	...
	constexpr char accepted[] = "<html>"
				    ...
				    "</html>";
	constexpr char no_content[] = ""; // The 204 response MUST NOT contain a message-body
	constexpr char multiple_choices[] = "<html>"
					    "<head><title>Multiple Choices</title></head>"
					    "<body><h1>300 Multiple Choices</h1></body>"
					    "</html>";
	constexpr char moved_permanently[] = "<html>"
					     "<head><title>Moved Permanently</title></head>"
					     "<body><h1>301 Moved Permanently</h1></body>"
					     "</html>";
	constexpr char moved_temporarily[] = "<html>"
					     "<head><title>Moved Temporarily</title></head>"
					     "<body><h1>302 Moved Temporarily</h1></body>"
					     "</html>";
	constexpr char not_modified[] = ""; // The 304 response MUST NOT contain a message-body
	constexpr char bad_request[] = "<html>"
				       "<head><title>Bad Request</title></head>"
				       "<body><h1>400 Bad Request</h1></body>"
				       "</html>";
	constexpr char unauthorized[] = "<html>"
	...
	constexpr char not_found[] = "<html>"
				     ...
				     "</html>";
	constexpr char internal_server_error[] = "<html>"
						 "<head><title>Internal Server Error</title></head>"
						 "<body><h1>500 Internal Server Error</h1></body>"
						 "</html>";
	constexpr char not_implemented[] = "<html>"
					   "<head><title>Not Implemented</title></head>"
					   "<body><h1>501 Not Implemented</h1></body>"
					   "</html>";
	constexpr char bad_gateway[] = "<html>"
				       "<head><title>Bad Gateway</title></head>"
				       "<body><h1>502 Bad Gateway</h1></body>"
				       "</html>";
	constexpr char service_unavailable[] = "<html>"
